...
describe "/projects/features.html.erb" do
  before(:each) do
    ...
    assigns[:project_features].stub(:total_pages).and_return 1
  end
  ...
  describe "GET, projects" do
    context "has no features"  do
      ...
      it "does not display a list of features" do
    ...
    context "has features"  do
      ...
      it "displays a list of features" do
      ...
      it "displays projects summary" do
